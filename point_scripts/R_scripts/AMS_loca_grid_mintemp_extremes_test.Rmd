...
ensembles_to_use0 = ensemble[!str_detect(ensemble, "GIS")]
ensembles_to_use = ensembles_to_use0[!str_detect(ensembles_to_use0, "CESM1-CAM5_r1i1p1")]
...
var2d.hist = ncvar_get(nc      = nc.loca,                      # netcdf file ID
                     ...
                     ) - 273.15                 # scaling temperature from K to DegC
...
var2d.hist = - var2d.hist
var2d.futr = - var2d.futr
...
for (ens_target in ensembles_to_use) {
  ...
  rcp45_base_period_ci_lb[ ens_target_num, ] = -return_GP[ , 3]
  rcp45_base_period_return[ens_target_num, ] = -return_GP[ , 2]
  rcp45_base_period_ci_ub[ ens_target_num, ] = -return_GP[ , 1]
  ...
  rcp85_base_period_ci_lb[ ens_target_num, ] = -return_GP[ , 3]
  rcp85_base_period_return[ens_target_num, ] = -return_GP[ , 2]
  rcp85_base_period_ci_ub[ ens_target_num, ] = -return_GP[ , 1]
  ...
  rcp45_per1_period_ci_lb[ ens_target_num, ] = -return_GP[ , 3]
  rcp45_per1_period_return[ens_target_num, ] = -return_GP[ , 2]
  rcp45_per1_period_ci_ub[ ens_target_num, ] = -return_GP[ , 1]
  ...
  rcp85_per1_period_ci_lb[ ens_target_num, ] = -return_GP[ , 3]
  rcp85_per1_period_return[ens_target_num, ] = -return_GP[ , 2]
  rcp85_per1_period_ci_ub[ ens_target_num, ] = -return_GP[ , 1]
...
beanplot(formula     = Return_Period_Values~merged_period_scenarios,  # formula selection for y axis
         ...
         side        = "both",
         main        = paste(location_name,
                             "LOCA Return Intervals for RCP 8.5",
                             sep = " "),         # title caption
         xlab        = "Return Period (Years)",               # xaxis title
         ylab        = paste("Minimum ",
                             variable_name,                   # yaxis title
...
beanplot(formula     = Return_Period_Values~merged_period_scenarios,  # formula selection for y axis
         ...
         side        = "both",
         main        = paste(location_name,
                             "LOCA Return Intervals for RCP4.5",
                             sep = " "),         # title caption
         xlab        = "Return Period (Years)",               # xaxis title
         ylab        = paste("Minimum ",
                             variable_name,                   # yaxis title
